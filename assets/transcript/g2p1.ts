...
Depending on what are your goals, you can look at different criteria of how to measure performance. It can be total return. It can be risk adjusted return or Sharpe ratio. It can be value at risk, which would be, the losses in details, which happens rarely.  
...
export const partii = `  
Takeaway: investment horizon influences your risk tolerance by a lot! 

The Research

So in this particular data, what we are looking at, we look at a different way to assess, let's say, quality of the portfolio, and this is stochastic dominance. 
...
So now so if you start from these premises, now we make one step forward is, the efficiency. Efficiency from the stochastic dominance portfolio. What does it mean? So I think you have several assets, and you can start a portfolio out of these assets. Question. 
...
[Insert capsule on Capital Allocation Line] 
`

export const partv = `
So and that's the kind of the idea which we start looking at. We'll say, okay. Fine. The lots of index funds you said and many of them that track, market indices across the world. 
